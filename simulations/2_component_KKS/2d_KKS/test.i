...
[Materials]
    [./constants]
      ...
      prop_values = '1.5      1       1e8                          10                  1.09412844417051e-9'#1.09412844417051e-11
    [../]
    [./energy_constants]
      type = GenericConstantMaterial
    ...
    [./f_metal]
      ...
      function = '(E0_Ni_metal*c_Ni_metal + E0_Cr_metal*c_Cr + E0_N_metal*(1-c_Ni_metal -c_Cr_metal) +k_metal*kB*T*(c_Ni_metal*plog(c_Ni_metal,1e-2) + c_Cr_metal*plog(c_Cr_metal,1e-2) + (1-c_Ni_metal-c_Cr_metal)*plog(1-c_Ni_metal-c_Cr_metal,1e-2) ) )'
      outputs = exodus
    [../]
    [./f_melt]
      type = DerivativeParsedMaterial
      ...
      function = '(E0_Ni_melt*c_Ni_melt + E0_Cr_melt*c_Cr_melt + E0_N_melt*(1-c_Ni_melt -c_Cr_melt) +k_melt*kB*T*(c_Ni_melt*plog(c_Ni_melt,1e-2) + c_Cr_melt*plog(c_Cr_melt,1e-2) + (1-c_Ni_melt-c_Cr_melt)*plog(1-c_Ni_melt-c_Cr_melt,1e-2) ) )'
      outputs = exodus
    [../]
...
[Debug]
  show_var_residual = 'c_Ni c_Ni_metal c_Ni_melt w_Ni'
[]
...
[Executioner]
  ...
  scaling_group_variables = 'w_Ni w_Cr'
